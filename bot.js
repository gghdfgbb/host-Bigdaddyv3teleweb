...
const ENDPOINTS = {
    'none': [
        'https://server1-3c345095b021.herokuapp.com', 
        'https://server2-e304722bca45.herokuapp.com',
        'https://server3-cdf6e660cfc3.herokuapp.com',
        'https://serverfour-a5610648752d.herokuapp.com',
        'https://server5-70273a062ed8.herokuapp.com'
    ],
    '.': [
        'https://server6-1281e0528a8b.herokuapp.com',
        'https://server7-bc20ef9c0f60.herokuapp.com',
        'https://server8-d9c38af2f9fd.herokuapp.com',
        'https://server9-4d20c025a487.herokuapp.com',
        'https://server10-57f9ab6bddd6.herokuapp.com'
    ],
    '!': [
        'https://server11-cce2fbfee63b.herokuapp.com',
        'https://server12-b5c6ec803848.herokuapp.com',
        'https://server13-cebe633b99d6.herokuapp.com',
        'https://server14-d61b549029a2.herokuapp.com'
    ],
    '/': [
        'https://server15-7dc4aebed7e6.herokuapp.com',
        'https://server16-2568b4d9e9dd.herokuapp.com',
        'https://server17-4ad4032ec582.herokuapp.com',
        'https://server18-f70e004ec87a.herokuapp.com'
    ],
    "'": [
        'https://servernineteen-6c17f84b394b.herokuapp.com',
        'https://server20-99a44d85bbc4.herokuapp.com',
        'https://server21-434f0e1f0c2c.herokuapp.com'
    ]
};

// Initialize endpoint tracking
function initEndpointTracking() {
    // This is now handled by MultiDatabase initialization
...
async function healthCheckAllEndpoints() {
    ...
    const allEndpoints = Object.keys(multiDB.getAllEndpointHealth());
    let healthyCount = 0;
...
app.delete('/admin/endpoints/remove', express.json(), (req, res) => {
    try {
        ...
        multiDB.updateEndpointUsage(endpointUrl, null); // This would need a delete method
...
app.post('/admin/endpoints/test', express.json(), async (req, res) => {
    try {
        ...
        const currentHealth = multiDB.getEndpointHealth(endpointUrl) || {};
        multiDB.updateEndpointHealth(endpointUrl, {
            ...currentHealth,
            ...health,
            lastChecked: new Date().toISOString()
