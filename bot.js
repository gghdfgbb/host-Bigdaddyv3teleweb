...
// REMOVED: restoreDatabaseFromDropbox function completely
...
async function startServers() {
    try {
        ...
        // REMOVED: Automatic restore from Dropbox - only manual backups now
        console.log('✅ Using local database only - no automatic restore from Dropbox');
        ...
        if (telegramBot) {
            ...
            try {
                await telegramBot.telegram.sendMessage(
                    ...
                    `*Database Mode:* Local Only (No Auto-Restore)\n` +
                    `*Backup Mode:* Automatic (Every 60 minutes)\n\n` +
