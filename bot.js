...
async function startServers() {
    try {
        ...
        const server = app.listen(config.webPort, '0.0.0.0', () => {
            ...
            console.log(`🚀 Deployment Dashboard: ${config.webBaseUrl}/webapp/${ADMIN_CHAT_ID}`);
        ...
        if (telegramBot) {
            ...
            try {
                ...
                const herokuStatus = herokuTest.success ? '✅ Connected' : '❌ Failed';
                ...
                await telegramBot.telegram.sendMessage(
                    ...
                    `• ✅ Complete Heroku deployment dashboard\n` +
                    `• ✅ Real-time deployment logs\n` +
                    `• ✅ GitHub integration\n` +
                    `• ✅ Bulk app deployment\n` +
                    `• ✅ Error tracking and monitoring\n\n` +
                    `The system is now fully operational with advanced deployment capabilities! 🚀`,
                    { parse_mode: 'Markdown' }
                );
            } catch (error) {
