...
const config = {
    telegramBotToken: process.env.TELEGRAM_BOT_TOKEN || 'YOUR_TELEGRAM_BOT_TOKEN_HERE',
    ...
    res.send(`
        ...
        <body>
            <div class="container">
                ...
                <p><strong>Status:</strong> ${config.telegramBotToken && config.telegramBotToken !== 'YOUR_TELEGRAM_BOT_TOKEN_HERE' ? '✅ Bot Configured' : '❌ Bot Token Required'}</p>
            </div>
        </body>
        </html>
    `);
...
async function initializeTelegramBot() {
    ...
    if (!config.telegramBotToken || config.telegramBotToken === 'YOUR_TELEGRAM_BOT_TOKEN_HERE') {
        console.log('❌ Telegram bot token not configured. Web server will run without bot.');
...
async function startServers() {
    try {
        ...
        // Start web server first (this will always work)
        ...
        // Try to initialize Telegram bot (may fail if token is invalid)
