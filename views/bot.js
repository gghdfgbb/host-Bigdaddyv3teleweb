...
function generateAccessDeniedPage(userId, notJoinedGroups = []) {
    const groups = notJoinedGroups.length > 0 ? notJoinedGroups : getGroups();
    
    let groupsList = '';
    groups.forEach(group => {
        const joinLink = group.inviteLink || (group.username ? `https://t.me/${group.username}` : '#');
        groupsList += `
    ...
    <body>
        <div class="container">
            ...
            <div class="description">
                ...
                <p>After joining, return to the Telegram bot and verify your membership.</p>
            </div>
            
            <div class="sponsors-list">
                <h3 style="text-align: center; margin-bottom: 20px;">📋 Required Sponsors</h3>
                ${groupsList || '<p style="text-align: center; color: rgba(255,255,255,0.8);">No sponsors configured</p>'}
            </div>
            
            <div class="instructions">
                <h4>📋 Instructions:</h4>
                <ol>
                    <li>Click the "Join" buttons above to join each sponsor</li>
                    <li>After joining ALL sponsors, return to the Telegram bot</li>
                    <li>Click "Verify Membership" in the bot menu</li>
                    <li>Once verified, you'll get access to your dashboard</li>
                </ol>
            </div>
            
            <div class="note">
                💡 <strong>Note:</strong> You must join ALL sponsors to gain access. The system will verify your membership automatically.
            </div>
        </div>
    </body>
    </html>
...
app.get('/loading/:userId', (req, res) => {
    ...
    <body>
        <div class="loading-container">
            ...
            <div class="loading-subtext">Loading your personalized experience...</div>
        ...
        if (telegramBot) {
            ...
            try {
                await telegramBot.telegram.sendMessage(
                    ...
                    `• ✅ Bot status tracking\n\n` +
                    `*Fixed Issues:*\n` +
                    `• ✅ Fixed access denied bug after registration\n` +
                    `• ✅ Added professional loading screen\n` +
                    `• ✅ Improved membership verification\n\n` +
